#ifndef HEURISTIC_DUMMY_H
#define HEURISTIC_DUMMY_H
...
/// </summary>
class HeuristicDummy : public IPrioHeuristic
{
public:
	/// <summary>
	...
	virtual uint32_t calculate_priority(AF &framework, list<uint32_t> &set_args, list<uint32_t> &initialSet, uint32_t query);
};
#endif