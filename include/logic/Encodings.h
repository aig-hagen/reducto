...
public:
    ...
    static void add_clauses_nonempty_admissible_set(SatSolver &solver, AF &framework, unordered_set<uint32_t> &activeArgs);
    /// <summary>
    ...
    static void add_complement_clause(SatSolver &solver, unordered_set<uint32_t> &activeArgs);
};
